...
VALUES 
    ('Vacuna A', 'Descripci�n de la Vacuna A', 1, '2024-10-09', 1),
    ('Vacuna B', 'Descripci�n de la Vacuna B', 1, '2024-09-30', 2),
    ('Vacuna C', 'Descripci�n de la Vacuna C', 0, '2024-09-15', 3),
    ('Vacuna D', 'Descripci�n de la Vacuna D', 1, '2024-10-01', 4),
    ('Vacuna E', 'Descripci�n de la Vacuna E', 1, '2024-10-05', 5);
